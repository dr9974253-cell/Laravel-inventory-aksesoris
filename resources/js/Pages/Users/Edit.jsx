            ...
            <div className="p-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Perbarui data user {user.name}</p>
                    </div>
                    <Link
                        href="/users"
                ...
                <div className="rounded-xl bg-white shadow-sm">
                    <div className="border-b border-gray-200 px-6 py-4">
                        <h3 className="text-lg font-semibold text-gray-800">Form Edit User</h3>
                    </div>
                    <div className="p-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-5">
                                ...
                                <p className="mt-1 text-xs text-gray-400">Isi hanya jika ingin mengubah password. Minimal 6 karakter.</p>
                            </div>
