...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
                <div className="flex h-full flex-col">
                    ...
                    <div className="border-t border-slate-700 p-4">
                        ...
                        <div className="mt-3 flex items-center justify-between">
                            <span
                                className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${isAdmin ? "bg-green-500/20 text-green-400" : "bg-slate-600 text-slate-300"}`}
                            >
                ...
                <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-6">
                    ...
                    <div className="flex-1 lg:flex lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-4 lg:hidden">
                            ...
                            <span
                                className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${isAdmin ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                            >
                                {isAdmin ? "Admin" : "Viewer"}
                            </span>
                        </div>
